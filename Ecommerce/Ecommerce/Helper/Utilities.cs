    ...
    public static class Utilities
    {
        ...
        public static async Task<string> UploadFile(Microsoft.AspNetCore.Http.IFormFile file, string sDirectory, string newname = null)
        {
            try
            {
                ...
                string pathFile = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "images", sDirectory, HashCode.Combine(newname) + newname );
                ...
                else
                {
                    ...
                    return HashCode.Combine(newname) +newname;
                }
            }
            catch 
            {
